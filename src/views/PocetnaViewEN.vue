<template>
    <div class="home">
      <section class="hero">
        ...
        <div class="hero-content">
          ...
          <h1 class="title">Welcome to <span class="highlight">L&P gallery</span>, the place where magic takes its material form.</h1>
        </div>
      </section>
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-8">
                  <div class="card-body">
                    ...
                    <a :href="'/EN/umetnik/'+artist.artist_id" class="btn btn-outline-danger">Visit the artist profile</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8">
                        <div class="card-body">
                            ...
                            <a :href="'/EN/slika/'+image.image_id" class="btn btn-outline-danger">Visit the image profile</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8">
                        <div class="card-body">
                            ...
                            <a :href="'/EN/skulptura/'+sculpture.sculpture_id" class="btn btn-outline-danger">Visit the sculpture profile</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8">
                        <div class="card-body">
                            ...
                            <a :href="'/EN/kreacija/'+creation.creation_id" class="btn btn-outline-danger">Visit the creation profile</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          <div v-for="offer in latestOffers" :key="offer.id" class="col-sm-12 col-md-6 col-lg-3">
            <div class="card md-3" style="max-width: 500px;">
              <div class="card-body">
                <h5 class="card-title">User: <span class="highlight">{{ offer.userId }}</span></h5>
                <h5 class="card-title">Offer: <span class="highlight">{{ offer.content }}$</span></h5>
                <h5 class="card-title">Category: <span class="highlight">{{ getCategoryNameEN(offer.type) }} {{ offer.artwork_id }}</span></h5>
                <p class="card-text">Date of offer: <span class="highlight">{{ formattedDate(offer.datetime) }}</span></p>
                <a :href="'/EN/' + getCategoryName(offer.type).toLowerCase() + '/' + offer.artwork_id" class="btn btn-outline-danger">Page of artwork</a>
              </div>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    mounted() {
      document.title = 'L&P gallery - Main';
    },
    computed: {
      latestOffers() {
    ...
    methods: {
      ...
      getCategoryNameEN(type) {
        if (type == "s") return "Image";
        if (type == "e") return "Sculpture";
        if (type == "x") return "Fashion";
      }
    }
  };
  </script>
