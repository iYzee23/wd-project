<template>
    <div>
        <div class="breadcrumb-div">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/EN/umetnine/slike">Images</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{image.image_name}}</li>
            </ol>
            </nav>
        </div>
        <div class="container">
            ...
            <div class="left-divs">
                <div class="left-div">
                    <div class="row">
                        <div class="col-sm-4">
                        <img :src="'/images/image' + image.image_id + '.jpeg'">
                        </div>
                        <div class="col-sm-8" style="margin-bottom: 5%;">
                            <h1 style="font-weight: bold; text-decoration: underline;">{{ image.image_name }}</h1><br><br>
                            ...
                            <br><br><br>
                            <h4 style="font-weight: bold">Estimated price: {{ image.image_estimated_price }}</h4>
                            <h4 style="font-weight: bold">Estimated age: {{ image.image_estimated_age }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                ...
                <div class="left-div down-left">
                        For mor info about image click
                        <a :href="image.image_wiki" target="_blank">here</a>
                </div>
            </div>
                    ...
                    <div class="carousel slide" id="demo" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img :src="'/image' + image.image_id + '/imageL.jpeg'" alt="ImageL">
                            </div>
                            <div class="carousel-item">
                                <img :src="'/image' + image.image_id + '/imageC.jpeg'" alt="ImageC">
                            </div>
                            <div class="carousel-item">
                                <img :src="'/image' + image.image_id + '/imageR.jpeg'" alt="ImageR">>
                            </div>
                        </div>
...
export default {
  ...
  created(){
        var imageId = Number(this.$route.params.id);
        this.image = this.images.find(image => image.image_id == imageId);
        this.currArtist = allArtistsEn.find(art => art.artist_name == this.image.image_author);
        this.showModal = false;
        this.loggedInUserId= localStorage.getItem('user');
  },
  mounted() {
    this.fetchPonude();
    document.title = 'L&P gallery - Image';
  },
  methods: {
