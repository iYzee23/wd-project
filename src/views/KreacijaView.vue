<template>
    <div>
        <div class="breadcrumb-div">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/umetnine/moda">Moda</a></li>
        ...
        <div class="container">
            ...
            <div class="left-divs">
                <div class="left-div">
                    <div class="row">
                        ...
                        <div class="col-sm-8" style="margin-bottom: 5%;">
                            ...
                            <br><br><br>
                            <h4 style="font-weight: bold">Procenjena vrednost: {{ creation.creation_estimated_price }}</h4>
                            <h4 style="font-weight: bold">Procenjena starost: {{ creation.creation_estimated_age }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <h5><b>Opis: </b>{{ creation.creation_description }}</h5>
                            <br>
                        </div>
                    </div>
                </div>
                <div class="left-div down-left">
                        ...
                        <a :href="creation.creation_wiki" target="_blank">ovde</a>
                </div>
            </div>
...
export default {
  ...
  created(){
        ...
        this.currArtist = allArtists.find(art => art.artist_name == this.creation.creation_author);
  ...
  mounted() {
    this.fetchPonude();
    document.title = 'L&P gallery - Kreacija';
  },
  methods: {
