<template>
    <div>
        <div class="breadcrumb-div">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/umetnine/slike">Slike</a></li>
                ...
                <div class="left-div">
                    <div class="row">
                        ...
                        <div class="col-sm-8" style="margin-bottom: 5%;">
                            ...
                            <br><br><br>
                            <h4 style="font-weight: bold">Procenjena vrednost: {{ image.image_estimated_price }}</h4>
                            <h4 style="font-weight: bold">Procenjena starost: {{ image.image_estimated_age }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <h5><b>Opis: </b>{{ image.image_description }}</h5>
                            <br>
                        </div>
                    </div>
                </div>
                <div class="left-div down-left">
                        Za više informacija o slici kliknite
                        <a :href="image.image_wiki" target="_blank">ovde</a>
                </div>
            </div>
