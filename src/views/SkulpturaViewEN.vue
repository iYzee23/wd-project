<template>
    <div>
        <div class="breadcrumb-div">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/EN/umetnine/skulpture">Sculptures</a></li>
                ...
                <div class="left-div">
                    <div class="row">
                        ...
                        <div class="col-sm-8" style="margin-bottom: 5%;">
                            ...
                            <br><br><br>
                            <h4 style="font-weight: bold">Estimated price: {{ sculpture.sculpture_estimated_price }}</h4>
                            <h4 style="font-weight: bold">Estimated age: {{ sculpture.sculpture_estimated_age }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <h5><b>Description: </b>{{ sculpture.sculpture_description }}</h5>
                            <br>
                        </div>
                    </div>
                </div>
                <div class="left-div down-left">
                        For mor info about sculpture click
                        <a :href="sculpture.sculpture_wiki" target="_blank">here</a>
                </div>
            </div>
...
export default {
  ...
  created(){
        ...
        this.currArtist = allArtistsEn.find(art => art.artist_name == this.sculpture.sculpture_author);
  ...
  mounted() {
    this.fetchPonude();
    document.title = 'L&P gallery - Sculpture';
  },
  methods: {
    ...
    fetchPonude() {
      this.ponude =JSON.parse(localStorage.getItem('allOffers')).filter((o)=>{
        return (o.artwork_id == Number.parseInt(this.$route.params.id) && o.type=='e')
      });
    },
